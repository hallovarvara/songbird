...
export const TV_SHOWS: IObjectOfStrings[] = [
  ...
  },
  {
    ...
    category: fantastic,
    description:
      'Политические интриги, родовитые лорды семи королевств, чудеса и надвигающиеся с севера ужасы откроют совершенно новый, непохожий на реальный, но невероятно живой мир. Кто победит в игре престолов, и можно ли в ней вообще победить?',
